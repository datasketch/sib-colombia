      ...
      {navGruposInteres.length !== 0 && gruposInteres && gruposInteres.length !== 0 && <div className='py-10 bg-white-2'>
        <div className='mx-auto w-10/12 max-w-screen-2xl'>
          <MenuExplorer tree={navGruposInteres} search={gruposInteres}>
            ...
            <MenuExplorer.Body>
              {(selected, info) => (
                <ContentElement slug={slug} selected={selected} info={info} parentlabel={generalInfo.parent_label} region={generalInfo.label} observadasCol={generalInfo.especies_region_estimadas} municipalityflag={municipalityflag} />
              )}
            </MenuExplorer.Body>
          </MenuExplorer>
        </div>
