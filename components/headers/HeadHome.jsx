    ...
    <>
      <div className='bg-banner-home bg-center bg-cover h-screen-75'>
        <div className='max-w-screen-xl mx-auto  h-full relative'>
          <div className='bg-black-2 bg-opacity-75 text-white absolute top-[20%] lg:top-1/4 left-10 xl:left-0 max-w-md flex flex-col w-1/2  justify-center px-3 lg:px-6 py-1.5 lg:py-3'>
      ...
      <div className='-mt-12 max-w-screen-xl w-9/12 mx-auto flex justify-end z-50'>
        <Tooltip />
      </div>
    </>
  )
