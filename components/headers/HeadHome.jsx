...
const HeadHome = ({ title, image, number }) => {
  ...
  return (
    <div className='bg-banner-home bg-center bg-cover h-screen-75 relative'>
      <div className='bg-black-2 bg-opacity-75 text-white absolute top-1/4 left-[8%] px-6 py-3 w-1/3 max-w-md flex flex-col justify-center'>
