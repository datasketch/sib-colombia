export default function PublishersCard ({ country, title, observationsQuantity, totalEspecies, imagePath }) {
  return (
        <div className='bg-white text-black-2 pb-8 w-full h-[230.23px] max-w-[308.04px] mx-auto lg:mx-0 overflow-y-scroll no-scrollbar shadow-default hover:shadow-xl'>
