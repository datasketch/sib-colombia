      ...
      <div className="mx-auto w-10/12 max-w-screen-2xl">
        <div className="flex items-center justify-between py-3">
          ...
          <div className="absolute top-2 right-0">
            <button
              onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
              className="flex items-center space-x-1 text-xs text-gray-600 hover:text-dartmouth-green transition-colors duration-200 px-2 py-1"
            >
            ...
            {sections.map((section) => {
              ...
              return (
                <button
                  ...
                  className={`flex-shrink-0 px-3 py-2 text-sm font-medium transition-colors duration-200 whitespace-nowrap relative ${
                    isActive
