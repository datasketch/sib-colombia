                    ...
                    : (<>
                      <div className='py-3 w-2/5 mx-auto'>
                        <FormControl fullWidth>
                          <InputLabel id="select-municipios">Departamentos</InputLabel>
                          <Select
...
{/*
      ...
      {optionShow === 'graph' && <div className='mt-[55.13px] '>
        <iframe className='h-screen w-full' src="https://datasketch.shinyapps.io/sib-data-app/?region=colombia"></iframe>
      </div>}
      {
