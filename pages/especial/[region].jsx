...
export async function getStaticPaths () {
  ...
  const specialRegions = ['reserva-forestal-la-planada', 'resguardo-indigena-pialapi-pueblo-viejo', 'region-amazonia']
...
export async function getStaticProps (context) {
  ...
  // For sponsors, use Colombia for region-amazonia, Nariño for others
  const parentRegion = region === 'region-amazonia' ? 'colombia' : 'narino'
