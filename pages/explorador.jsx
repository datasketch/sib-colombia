...
function explorador () {
  ...
  const appURL = query ? `https://services.datasketch.co/org_sibhumboldt_sibdata_app2?published=true&${query}` : 'https://services.datasketch.co/org_sibhumboldt_sibdata_app2?published=true'
