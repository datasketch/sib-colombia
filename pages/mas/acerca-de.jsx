        ...
        <div className='w-10/12 lg:w-9/12 mx-auto py-10 space-y-12 font-lato'>
          ...
          <div className='space-y-3 md:w-3/4 mx-auto'>
            ...
            <div className='flex flex-col gap-y-3  lg:flex-row justify-between'>
              <a href='/mas/glosario' target='_blank' className='py-2 px-2.5 border border-black rounded-full' >Grupos biológicos</a>
              <a href='/mas/glosario' target='_blank' className='py-2 px-2.5 border border-black rounded-full' >Grupos biológicos de interés</a>
              <a href='/mas/glosario' target='_blank' className='py-2 px-2.5 border border-black rounded-full' >Temáticas</a>
              <a href='/mas/glosario' target='_blank' className='py-2 px-2.5 border border-black rounded-full' >Regiones</a>
            </div>
          </div>
