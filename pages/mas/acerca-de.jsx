      ...
      <div className='flex max-w-screen-2xl mx-auto'>
        <div className='w-10/12 lg:w-9/12 mx-auto py-10 space-y-12 font-lato'>
          <div className='space-y-2 md:w-3/4 mx-auto'>
            ...
            <p className='font-lato' >Biodiversidad en Cifras es una de las plataformas del ecosistema web del SiB Colombia, diseñada para presentar de manera sintetizada el estado del conocimiento de la biodiversidad del país, y su regionalización a partir de los datos e información disponibles a través del SiB Colombia y fuentes secundarias. Esta plataforma cuenta con cuatro ejes principales de síntesis: (A) cifras por grupos biológicos, (B) cifras por áreas geográficas, (C) temáticas de conservación, uso y manejo, siendo este último un eje transversal a los dos anteriores y (D) cifras por organizaciones publicadoras de datos. Adicionalmente a los cuatro ejes de síntesis, se presenta un paralelo con cifras estimadas (E) a partir de literatura.</p>

            <p className='font-lato' >Biodiversidad en Cifras, además de permitir consultar el estado de conservación y amenaza de la biodiversidad a nivel nacional, representa el proceso de regionalización del SiB Colombia, convirtiéndose también en la ventana a la biodiversidad regional, con cifras más detalladas para algunas regiones, como es el caso para los departamentos de Santander, Boyacá, Tolima, Nariño, Amazonas, Caquetá, Guainía, Guaviare, Putumayo y Vaupés.</p>
            ...
            <p className='font-lato' >
              Adicionalmente, las listas de referencia taxonómicas (ACO, 2022: <a target='_blank' className='underline italic text-azure' href='https://ipt.biodiversidad.co/sib/resource?r=aco_listaavescolombia2017' rel="noreferrer">Lista de referencia de especies de aves de Colombia</a>; ACCICTIOS, 2024: <a target='_blank' className='underline italic text-azure' href='https://ipt.biodiversidad.co/sib/resource?r=ictiofauna_colombiana_dulceacuicola' rel="noreferrer">Lista de especies de peces de agua dulce de Colombia</a>; ACCICTIOS, 2023: <a target='_blank' className='underline italic text-azure' href='https://ipt.biodiversidad.co/sibm/resource?r=checklist_pacifico' rel="noreferrer">Checklist of Pacific marine fishes of Colombia</a>; ACCICTIOS, 2023: <a target='_blank' className='underline italic text-azure' href='https://ipt.biodiversidad.co/sibm/resource?r=checklist_caribe' rel="noreferrer">Checklist of Caribbean marine fishes of Colombia</a>; SCmas, 2024: <a target='_blank' className='underline italic text-azure' href='https://ipt.biodiversidad.co/sib/resource?r=mamiferos_col' rel="noreferrer">Lista de mamíferos de Colombia</a>; UNAL, 2020: <a target='_blank' className='underline italic text-azure' href='https://ipt.biodiversidad.co/sib/resource?r=catalogo_plantas_liquenes' rel="noreferrer">Catálogo de plantas y líquenes de Colombia</a>; ColeopCol, 2024: <a target='_blank' className='underline italic text-azure' href='https://www.gbif.org/dataset/search?publishing_org=2c39be5c-c11e-46d0-bcb4-552f2072d19f' rel="noreferrer">Listas de especies de Coleópteros de Colombia</a> y la <a target='_blank' className='underline italic text-azure' href='https://www.gbif.org/dataset/168568e7-eb5f-4ef6-8c59-f73ceaf57e91' rel="noreferrer">lista temática de especies exóticas del país</a> (Baptiste et. al, 2018), son usadas para la validación y ajuste de estas cifras, evitando así las sobreestimaciones.
            </p>
